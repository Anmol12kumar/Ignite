...
const Assessment6 = () => {
    ...
    const [questions, setQuestions] = useState(level6Questions);
    ...
    useEffect(() => {
        if (typeof window !== "undefined") {
            ...
            setQuestions(getPersonalizedQuestions(level6Questions, profession, domain));
        }
    }, []);
    ...
    const isLastQuestion = selectedQ === level6Questions[questions.length - 1].id;
