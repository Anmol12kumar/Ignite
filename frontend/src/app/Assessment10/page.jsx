...
const Assessment10 = () => {
    ...
    const [questions, setQuestions] = useState(level10Questions);
    ...
    useEffect(() => {
        if (typeof window !== "undefined") {
            ...
            setQuestions(getPersonalizedQuestions(level10Questions, profession, domain));
        }
    }, []);
    ...
    const isLastQuestion = selectedQ === level10Questions[questions.length - 1].id;
