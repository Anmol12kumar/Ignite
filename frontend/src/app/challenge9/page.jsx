...
const ScoreCard = ({ score, onNext, isLast, suggestions }) => {
    ...
    return (
        <div className="mt-6 p-6 rounded-xl border border-gray-700 bg-gray-900 animate-fade-in">
            ...
            {isLast && score >= 50 && (
                <Link href="/challengeResults?level=9">
...
const Challenge9 = () => {
    ...
    const [questions, setQuestions] = useState(level9ChallengeQuestions);
    ...
    useEffect(() => {
        if (typeof window !== "undefined") {
            ...
            setQuestions(getPersonalizedChallengeQuestions(level9ChallengeQuestions, profession, domain));
        }
    }, []);
