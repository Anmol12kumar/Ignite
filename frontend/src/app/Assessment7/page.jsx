...
const Assessment7 = () => {
    ...
    const [questions, setQuestions] = useState(level7Questions);
    ...
    useEffect(() => {
        if (typeof window !== "undefined") {
            ...
            setQuestions(getPersonalizedQuestions(level7Questions, profession, domain));
        }
    }, []);
    ...
    const isLastQuestion = selectedQ === level7Questions[questions.length - 1].id;
