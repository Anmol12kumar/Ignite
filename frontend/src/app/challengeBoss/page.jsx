...
const ChallengeBoss = () => {
    ...
    const [questions, setQuestions] = useState(bosslevelChallengeQuestions);
    ...
    useEffect(() => {
        if (typeof window !== "undefined") {
            ...
            setQuestions(getPersonalizedChallengeQuestions(bosslevelChallengeQuestions, profession, domain));
        }
    }, []);
