...
const ScoreCard = ({ score, onNext, isLast, suggestions }) => {
    ...
    return (
        <div className="mt-6 p-6 rounded-xl border border-gray-700 bg-gray-900 animate-slideUp hover:shadow-lg hover:border-emerald-400/30 transition-all duration-300">
            ...
            {isLast && score >= 50 && (
                <Link href="/challengeResults?level=1">
...
const Challenge = () => {
    ...
    const [questions, setQuestions] = useState(level1ChallengeQuestions);
    ...
    useEffect(() => {
        if (typeof window !== "undefined") {
            ...
            setQuestions(getPersonalizedChallengeQuestions(level1ChallengeQuestions, profession, domain));
        }
    }, []);
