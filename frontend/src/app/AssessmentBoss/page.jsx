...
const AssessmentBoss = () => {
    ...
    return (
        <div className="h-screen flex flex-col bg-gradient-to-b from-gray-950 via-red-950/40 to-gray-950 text-white">
            {/* Top bar */}
            <nav className="flex-shrink-0 px-30 border-b border-red-900/60 bg-black/90 backdrop-blur-xl z-50">
                <div className="container flex h-14 items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="w-32 h-2 rounded-full bg-red-950/50 overflow-hidden border border-red-800/40">
                            <div
                                className="h-full rounded-full bg-linear-to-r from-orange-600 to-red-600 transition-all duration-500 shadow-lg shadow-red-600/50"
                                style={{ width: `${completionPct}%` }}
                            />
                        </div>
                        <span className="font-mono text-xs font-bold text-orange-500">{completionPct}%</span>
                    </div>
                </div>
            </nav>
            ...
            <div ref={containerRef} className="flex-1 flex overflow-hidden relative select-none">
                ...
                <div className="overflow-y-auto border-r-0" style={{ width: `${dividerPos}%` }}>
                    <div className="p-6">
                        <h2 className="font-mono text-[11px] tracking-[0.2em] uppercase text-red-400 mb-4">
                                ...
                                return (
                                    <button
                                        ...
                                        className={`w-full text-left p-4 rounded-lg border transition-all duration-300 ${!isUnlocked
                                            ? "opacity-50 cursor-not-allowed border-red-900/40 bg-gray-900/40"
                                            : selectedQ === q.id
                                                ? "border-red-500 bg-red-600/20 shadow-[0_0_20px_-8px_rgba(239,68,68,0.6)] scale-105"
                                                : "border-red-900/50 bg-gray-900/60 hover:-translate-y-1 hover:border-red-500/50 hover:bg-red-950/30 hover:shadow-lg hover:shadow-red-500/10"
                                            }`}
                                    >
                                        <div className="flex items-start gap-3">
                                            <span
                                                className={`flex-shrink-0 w-7 h-7 rounded-full flex items-center justify-center text-xs font-mono font-bold ${!isUnlocked ? "bg-red-900/40 text-gray-600" :
                ...
                <div
                    ...
                    className="w-2 flex-shrink-0 bg-red-900/30 hover:bg-red-500/40 active:bg-red-500/60 cursor-col-resize transition-colors duration-150 relative z-10 flex items-center justify-center"
                >
                ...
                <div className="flex-1 overflow-y-auto">
                    {!activeQuestion ? (
                        ...
                        <div className="p-6 max-w-2xl">
                            {/* Question display */}
                            <div className="mb-6">
                                <span className="font-mono text-[11px] tracking-[0.2em] uppercase text-red-400 mb-2 block">
                            ...
                            <div className="mb-6 rounded-xl border border-red-700/60 bg-red-950/40 p-5 shadow-lg shadow-red-900/30">
                                <h4 className="text-s font-mono uppercase tracking-wider text-red-400 mb-3 flex items-center gap-2">
                                    🔴 Sample Answer
                                </h4>
                                ...
                                <div className="mt-4 pt-3 border-t border-red-700/30">
                                    <h5 className="text-xs font-mono uppercase tracking-wider text-red-300/70 mb-2">Key Points to Include:</h5>
                                    <ul className="space-y-1">
                                        {activeQuestion.keyPoints.map((point, i) => (
                                            <li key={i} className="text-s text-red-200/70 flex items-start gap-2">
                                                <span className="text-red-500 mb-0.5">•</span> {point}
                                            </li>
                                        ))}
                                    </ul>
                                </div>
                            ...
                            <div className="mb-4">
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <textarea
                                        ...
                                        rows={6}
                                        className="flex-1 rounded-lg border border-red-800/60 bg-gray-900/80 p-4 text-sm text-white placeholder:text-gray-400/50 focus:outline-none focus:border-red-500 focus:ring-2 focus:ring-red-500/50 focus:shadow-xl focus:shadow-red-500/20 resize-none transition-all duration-300 focus:scale-[1.01]"
                                    />
                                    ...
                                    <div className="flex flex-col gap-2">
                                        <button
                                            ...
                                            className={`p-3 rounded-lg border-2 transition-all duration-300 flex items-center justify-center h-14 w-14 hover:-translate-y-1 hover:shadow-lg active:scale-95 ${
                                                isListening
                                                    ? "border-orange-500 bg-orange-500/20 text-orange-400 hover:bg-orange-500/30 hover:shadow-orange-500/20 animate-pulse"
                                                    : "border-orange-600/50 bg-orange-600/10 text-orange-400 hover:border-orange-400 hover:bg-orange-600/30 hover:shadow-lg hover:shadow-orange-500/20"
                                            }`}
                                        ...
                                        {voiceStatus && (
                                            <div className="p-2 rounded-lg bg-orange-900/30 border border-orange-500/30 text-center">
                                                <p className="text-xs text-orange-300 truncate">{voiceStatus}</p>
                                            </div>
                                        )}
                            ...
                            <Button disabled={isEvaluating} onClick={handleSubmit} variant="hero" size="lg" className="w-full mb-8 bg-red-600 text-white hover:bg-red-700 shadow-md hover:shadow-2xl hover:shadow-red-600/50 hover:-translate-y-1 active:scale-95 transition-all duration-300 disabled:opacity-75">
                            ...
                            {feedback && (
                                <div className="space-y-5 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                    <div className={`rounded-xl border p-5 shadow-lg ${feedback.pct >= 75 ? "border-orange-500/60 bg-orange-600/20"
                                        : feedback.pct >= 50 ? "border-yellow-500/40 bg-yellow-500/10"
                                            : "border-red-600/60 bg-red-600/20"
                                        }`}>
                                        <div className="flex items-center gap-3 mb-2">
                                            <span className="text-2xl">{feedback.pct >= 75 ? "🔥" : feedback.pct >= 50 ? "🔶" : "💀"}</span>
                                            <div>
                                                <span className={`text-2xl font-bold ${feedback.pct >= 75 ? "text-orange-400" : feedback.pct >= 50 ? "text-yellow-400" : "text-red-400"}`}>{feedback.pct}%</span>
                                                <span className="text-sm text-gray-400 ml-2">accuracy</span>
                                            </div>
                                        </div>
                                        <div className="h-2 rounded-full bg-red-950/50 overflow-hidden border border-red-800/40">
                                            <div className={`h-full rounded-full transition-all duration-700 ${feedback.pct >= 75 ? "bg-orange-500" : feedback.pct >= 50 ? "bg-yellow-500" : "bg-red-600"
                                    ...
                                    {feedback.matched.length > 0 && (
                                        <div>
                                            <h4 className="text-xs font-mono uppercase tracking-wider text-orange-400 mb-2">✓ What you got right</h4>
                                            <ul className="space-y-1">
                                    ...
                                    {feedback.suggestions && (
                                        <div className="mt-4 p-4 rounded-lg bg-red-600/15 border border-red-600/40">
                                            <h4 className="text-xs font-mono uppercase tracking-wider text-red-400 mb-2 flex items-center gap-2">⚡ Boss Insights</h4>
                                            <p className="text-sm text-red-200/80 leading-relaxed">{feedback.suggestions}</p>
                                        </div>
                                    )}
                                    ...
                                    {feedback.passed && !isLastQuestion && (
                                        <div className="mt-6 p-4 rounded-lg bg-orange-600/20 border border-orange-600/40 text-center flex flex-col items-center shadow-lg shadow-orange-600/20">
                                            <p className="text-orange-400 font-semibold mb-1">🔥 Victory! (Score {feedback.pct}%)</p>
                                    ...
                                    {isLastQuestion && allCompleted && feedback.passed && (
                                        <div className="mt-6 p-4 rounded-lg bg-red-600/20 border border-red-500/60 text-center flex flex-col items-center shadow-lg shadow-red-600/30">
                                            <p className="text-red-300 font-semibold mb-1">⚔️ Boss Level Mastered!</p>
                                            <p className="text-sm text-red-200/80 mb-4">You've defeated all boss challenges. Ready for the ultimate test?</p>
                                            <Link href="/challengeBoss" className="w-full">
                                                <Button size="lg" className="w-full bg-red-600 text-white hover:bg-red-700 font-semibold">
                                                    🔥 Face the Boss Challenge
                                                </Button>
                                            </Link>
                                        </div>
                                    )}
