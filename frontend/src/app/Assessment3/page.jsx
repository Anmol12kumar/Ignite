...
const Assessment3 = () => {
    ...
    const [questions, setQuestions] = useState(level3Questions);
    ...
    useEffect(() => {
        if (typeof window !== "undefined") {
            ...
            setQuestions(getPersonalizedQuestions(level3Questions, profession, domain));
        }
    }, []);
    ...
    const isLastQuestion = selectedQ === level3Questions[questions.length - 1].id;
