...
const Assessment8 = () => {
    ...
    const [questions, setQuestions] = useState(level8Questions);
    ...
    useEffect(() => {
        if (typeof window !== "undefined") {
            ...
            setQuestions(getPersonalizedQuestions(level8Questions, profession, domain));
        }
    }, []);
    ...
    const isLastQuestion = selectedQ === level8Questions[questions.length - 1].id;
