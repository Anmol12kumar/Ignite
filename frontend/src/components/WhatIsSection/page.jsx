        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
                ...
                <ScrollReveal delay={200}>
                    <p className="text-secondary-foreground text-gray-400 px-30 leading-relaxed mb-5">
                ...
                <ScrollReveal delay={300}>
                    <p className="text-secondary-foreground text-gray-400 px-30 leading-relaxed">
            ...
            <ScrollReveal delay={150}>
                <div className="border border-border/60 bg-gray-900 rounded-lg p-8 bg-card">
                    <h3 className="font-semibold mb-5 text-xl">Why It Matters</h3>
                    <div className="space-y-4">
                        {whyItMatters.map((item) => (
                            <div key={item.n} className="flex gap-4">
                                <span className="font-mono text-m text-primary text-emerald-600 mt-1 shrink-0">{item.n}</span>
                                <p className="text-l text-secondary-foreground text-gray-400 leading-relaxed">{item.text}</p>
                            </div>
                        ))}
                    </div>
                </div>
